...
// Do not use clipboard routines
#define GRIDCONTROL_NO_PRINTING
// Do not use printing routines
...
{
    DECLARE_FIXED_ALLOC(CFixedAllocGridRow);
};*/
...
#define GVN_FIRST				(0U-2000U)
#define GVN_LAST				(0U-2999U)

#define GVN_SELCHANGING         (GVN_FIRST - 0) 
#define GVN_SELCHANGED          (GVN_FIRST - 1) 
#define GVN_DELETEITEM          (GVN_FIRST - 3)
#define GVN_BEGINLABELEDIT      (GVN_FIRST - 5)
#define GVN_ENDLABELEDIT        (GVN_FIRST - 6) 
#define GVN_COLUMNCLICK         (GVN_FIRST - 8) 
#define GVN_BEGINDRAG           (GVN_FIRST - 9) 
#define GVN_BEGINRDRAG          (GVN_FIRST - 11)
#define GVN_ODCACHEHINT         (GVN_FIRST - 12) 
#define GVN_LBUTTONDOWN         (GVN_FIRST - 13)
#define GVN_LBUTTONUP           (GVN_FIRST - 14)
#define GVN_GETDISPINFO         (GVN_FIRST - 15)
#define GVN_DBLCLK				(GVN_FIRST - 16)
#define GVN_RCLICK				(GVN_FIRST - 17)	
